...
public class Roulette {
    ...
    public static void main(String[] args) {
        ...
        if (result == 0) { //If sats där om resultatet är 0, så stängs datorn ner. Annars händer ingenting.
            ...
            System.out.println("wow let's go very nice"); //Printar helt enkelt detta om man får ett värde som inte är 0
        }
